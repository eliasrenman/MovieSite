<template>
<a class="github" v-if="!isMobile" href="https://github.com/eliasrenman/MovieSite" target="_blank">
    <svg class="github"
        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32.58 31.77">
        <!-- <defs>
